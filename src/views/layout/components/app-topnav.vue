    ...
    <div class="navbar-inner">
      <div class="container1">
        <div class="left-side">
          ...
          <div v-if="windowWidth > 824" class="nav-items">
            <a :href="item.to" v-for="item in navItems" :key="item.to">
              <span class="nav-item Fon24-500">
                {{ item.text }}
              </span>
            </a>
          </div>
    ...
    >
      ...
      <div class="drawer-content1">
        <ul v-for="(item, index) in navItems" :key="item.to">
          <a @click="handleClickLInk(item.to, index)">
